USE [PuntoDeVenta]
GO
/****** Object:  StoredProcedure [dbo].[SP_RESTAURANTE_OBTENERL_PRODUCTOS_AGRUPADOS_MESA]    Script Date: 30/03/2020 01:50:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

if exists (select * from sysobjects where name like 'SP_RESTAURANTE_OBTENERL_PRODUCTOS_AGRUPADOS_MESA' and xtype = 'p')
	drop proc SP_RESTAURANTE_OBTENER_TOTAL_PRODUCTOS_MESA
go

CREATE proc

	[dbo].[SP_RESTAURANTE_OBTENERL_PRODUCTOS_AGRUPADOS_MESA]
...
as
	...
	grant exec on SP_RESTAURANTE_OBTENERL_PRODUCTOS_AGRUPADOS_MESA to public
	go
